...
<div class="col-sm-4">
	...
	<button type="submit" value="Change Password" name="change" class="btn btn-info btn-md">Change Password</button>
</form>
	<form action="logout.php" method="post" align='right'><button style="width:142px" type="submit" value="logout" name="logout" class="btn btn-danger btn-md">Logout</button></form>
	<form action="order_status.php" align='right' method="post">
	<button type="submit" value="Status" name="status" style="width:142px" class="btn btn-warning btn-md">Order status</button>
	</form>
	...
	<div class="container">
		  <ul class="nav nav-tabs">
			<li><a href="softwaremainlogin.html">Home</a></li>
