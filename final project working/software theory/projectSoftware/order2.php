...
<div class='col l8'>
<h1 align='center' style='color:#8B4513' >Invoice</h1>
<table>
<tr style='background-color:#DAA520'><th>Item</th><th>Quantity</th><th>Subtotal</th></tr>";
$cost=0;
$order="<table>";
...
if(isset($_POST['902']))
 ...
 echo $order;
 echo "<tr><h3 align='center' style='color:#8B4513'>The Grand total :".$cost ."</h3></tr></table>";
echo "</div><div class='col l2'><p></p></div></div></div></body></html>";
 }
?>